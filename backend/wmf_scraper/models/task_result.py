...
class TaskResultModel(SQLModel, table=True):  # type: ignore
    task_id: int | None = Field(primary_key=True, foreign_key="taskmodel.task_id")
    competitor_id: int | None = Field(primary_key=True, foreign_key="competitormodel.competitor_id")
